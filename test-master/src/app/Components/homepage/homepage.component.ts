...
inputName: string = "";
  constructor(private router: Router, private postService: PostsService, private sharedService: SharedService, private shoppingService: ShoppingService, private postsService: PostsService) { }
